...
void loop()
{
  ...
  now = time(nullptr);
  //Lee los datos del sensor de temperatura y humedad
  float h = dht.readHumidity();
  float t = dht.readTemperature();
  //Lee los datos del sensor de luminosidad (LDR)
